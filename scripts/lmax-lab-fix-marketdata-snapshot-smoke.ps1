...
dotnet run --project $project --no-build --no-restore -- fix-marketdata-snapshot-smoke --environment=$EnvironmentName --allow-external-connections=$($AllowExternalConnections.IsPresent)
