...
dotnet run --project $project --no-build --no-restore -- fix-order-logon-smoke --environment=$EnvironmentName --allow-external-connections=$($AllowExternalConnections.IsPresent)
