...
$root='C:\deploy\IntradayPlatform\operator\lmax-demo-orchestration\daily-eod-20260918'
...
Register-ScheduledTask -TaskName $name -Action $action -Trigger $trigger -Principal $principal -Settings $settings -Description 'Demo EOD only: exact-date local exports, import, reconciliation, provisional recap. No trading, email or portal access. Requires Administrator logged on.' | Out-Null
