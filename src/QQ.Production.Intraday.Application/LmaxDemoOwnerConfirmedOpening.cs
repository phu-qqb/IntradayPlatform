...
public static class LmaxDemoOwnerConfirmedOpening
{
    ...
    public const string Approval = "https://github.com/phu-qqb/IntradayPlatform/issues/84#issuecomment-5730268654";
    public const string Quote = "la position est flat et il n'y a aucun ordre. J'aimerais qu'on lance le trading pour la journée";
    public static readonly DateTimeOffset RecordedAt = DateTimeOffset.Parse("2026-09-18T12:52:03.0232487Z");
    ...
    {
        Require(proof.GetProperty("schema").GetString() == "lmax_demo_owner_confirmation_v1"
