...
public static class Arch7bV2QualificationFactory
{
    ...
    private static string[] ProducedFacts(string stage) => stage switch
    {
        ...
        "CLOCK_PREFLIGHT" => [Arch7bClockFactContracts.PreflightFactType],
        "CLOCK_CAPTURE_START" => [Arch7bClockFactContracts.CaptureStartFactType],
        "CLOCK_POST_CLOSE" => [Arch7bClockFactContracts.PostCloseFactType],
