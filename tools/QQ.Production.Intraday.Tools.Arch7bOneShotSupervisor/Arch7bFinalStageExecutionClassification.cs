...
public static class Arch7bFinalStageExecutionCatalog
{
    ...
    private static IReadOnlyList<Arch7bFinalStageExecutionEntry> Build()
    {
        var values = new[]
        {
            ...
            Child("MARKET_PREARM", Arch7bFinalStageExecutionClasses.LongLivedChildStart,
                Arch7bExecutionKind.ChildStartLongLived, true, "market-data-recorder",
                ...
                "market-recorder-v1", "market recorder lifecycle", ["market-ready.json", "market-capture.json"],
                "Start the single bounded market-data-only child."),
            ...
            Child("MARKET_CAPTURE", Arch7bFinalStageExecutionClasses.LongLivedChildSignalOrStop,
                Arch7bExecutionKind.ChildAwaitEvidence, false, "market-data-recorder",
                "phu-qqb/IntradayPlatform", "QQ.Production.Intraday.Tools.LmaxMarketDataCaptureOnly",
                "await-evidence", "arch6f_lmax_market_data_slot_capture_v1", null,
                "ready/evidence markers", [], "Await evidence from the already-running market child."),
            Internal("CLOCK_POST_CLOSE", "Produce and validate the independent post-close clock snapshot."),
            Child("MARKET_FINALIZATION", Arch7bFinalStageExecutionClasses.LongLivedChildSignalOrStop,
                Arch7bExecutionKind.ChildStop, true, "canonical-slot-finalizer",
                "phu-qqb/IntradayPlatform", "QQ.Production.Intraday.Tools.Arch6fEconomicReplay",
                ...
                "Signal/stop the market child and publish canonical slot evidence."),
