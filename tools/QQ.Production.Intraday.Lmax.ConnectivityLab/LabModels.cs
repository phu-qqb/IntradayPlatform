...
public interface ILmaxFixSessionClient
{
    ...
    Task<LmaxFixArch7bProductionReadinessResult> Arch7bProductionReadinessAsync(LmaxConnectivityLabOptions options, LmaxFixArch7bProductionReadinessBinding binding, bool explicitReadinessConfirmation, CancellationToken cancellationToken)
        => Task.FromResult(LmaxFixArch7bProductionReadinessResult.Skipped(
            "ARCH7B_PRODUCTION_READINESS_RAW_FIX_CLIENT_REQUIRED"));
    Task<LmaxFixArch7bProductionReadinessResult> Arch7bProductionReadinessValidateOnlyAsync(LmaxConnectivityLabOptions options, LmaxFixArch7bProductionReadinessBinding binding, bool explicitReadinessConfirmation, CancellationToken cancellationToken)
        => Task.FromResult(LmaxFixArch7bProductionReadinessResult.Skipped(
            "ARCH7B_PRODUCTION_READINESS_RAW_FIX_CLIENT_REQUIRED"));
