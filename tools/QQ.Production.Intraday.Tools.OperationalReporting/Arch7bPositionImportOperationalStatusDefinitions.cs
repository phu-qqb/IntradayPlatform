...
public static class Arch7bPositionImportOperationalStatusDefinitions
{
    ...
    [
        ...
        Code(Arch7bFreshPositionImportFastPathContract.PackageSloExceeded,
            "FRESHNESS", OperationalBreakSeverity.Error,
            "The canonical four-file import package was not ready within 60 seconds of broker P2.",
            Arch7bFreshPositionImportFastPathContract.Version),
        Code(Arch7bFreshPositionImportFastPathContract.ReadySloExceeded,
            "FRESHNESS", OperationalBreakSeverity.Error,
            "The atomic ready marker was not published within 90 seconds of broker P2.",
            Arch7bFreshPositionImportFastPathContract.Version),
        Code(Arch7bFreshPositionImportFastPathContract.PlanSloExceeded,
            "FRESHNESS", OperationalBreakSeverity.Error,
            "The final read-only import plan did not start within 120 seconds of broker P2.",
            Arch7bFreshPositionImportFastPathContract.Version),
        Code(Arch7bFreshPositionImportFastPathContract.ApplyStartSloExceeded,
            "FRESHNESS", OperationalBreakSeverity.Critical,
            "The append-only apply did not start within 150 seconds of broker P2.",
            Arch7bFreshPositionImportFastPathContract.Version),
        ...
        Code("ARCH7B_POSITION_IMPORT_SOURCE_INGESTION_MISMATCH", "LINEAGE",
            OperationalBreakSeverity.Critical,
            "The prearmed source ingestion differs from the exact fast-path source ingestion.",
            Arch7bFreshPositionImportFastPathContract.Version),
        Code("ARCH7B_POSITION_FAST_PATH_LATE_ARM_REJECTED", "FRESHNESS",
            OperationalBreakSeverity.Critical,
            "The importer arm was created after broker P2 and cannot authorize the fresh fast path.",
            Arch7bFreshPositionImportFastPathContract.Version),
