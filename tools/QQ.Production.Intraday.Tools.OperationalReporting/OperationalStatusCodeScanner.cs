...
public static partial class OperationalStatusCodeScanner
{
    ...
    [
        ...
        "RPT2_ROADMAP_AUTHORITY_PATH_MISMATCH",
        "RPT2_ROADMAP_MANIFEST_ID_MISMATCH",
        "RPT2_ROADMAP_MANIFEST_VERSION_MISMATCH",
        "RPT2_ROADMAP_STATUS_MISMATCH",
        "RPT2_ROADMAP_MASTER_IDENTITY_MISSING",
        "RPT2_ROADMAP_CONTENT_INCOMPLETE",
        "RPT2_SELECTED_MODEL_SET_INCOMPLETE",
        "RPT2_SELECTED_MODEL_LINEAGE_MISMATCH",
        "RPT2_SELECTED_MODEL_COUNTS_MISMATCH",
        "RPT2_POSITION_ONLY_DRIFT_ARITHMETIC_MISMATCH",
        "RPT2_MARKET_DATA_CONTENT_SHA_MISMATCH",
        "RPT2_TARGET_POSITION_CONTENT_SHA_MISMATCH",
        "RPT2_DRIFT_CONTENT_SHA_MISMATCH",
        "RPT2_PROJECTION_INPUT_SHA_MISMATCH",
        "RPT2_PROJECTION_MANIFEST_SHA_MISMATCH",
        "RPT2_PROJECTION_IDENTITY_MISMATCH",
        "SOURCE_POSITION_SNAPSHOT_COVERAGE_INCOMPLETE",
        "RPT2_REPOSITORY_COMMIT_MISMATCH",
        "RPT2_REPOSITORY_BUILD_COMMIT_MISMATCH",
        "GAP_SPANNING_AUTHORITATIVE_SNAPSHOTS",
        "ARCH7A_ARCH7B_ECONOMIC_REVISION_MISMATCH",
        "ARCH7A_ARCH7B_SLOT_MISMATCH",
